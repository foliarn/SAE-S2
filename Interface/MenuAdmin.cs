...
namespace Interface
{
    ...
    public partial class MenuAdmin : Form
    {
        ...
        // Créer/supprimer un arrêt ou une ligne 
        private void btnCreationValider_Click(object sender, EventArgs e)
        {
        ...
        // Modifier un arrêt
        private void pnlChangerNomArret_Click(object sender, EventArgs e)
        {
        ...
        // modifications d'appartenance d'un arrêt à une ligne
        ...
        private void btnArretModifLigneValider_Click(object sender, EventArgs e)
        {
            ...
            if (cmbArretModifLigneChoixSuppr.Enabled)
            {
                ...
                if (ModifBDD.RetirerArretDeLigne(idChoixMain, idLigne))
                {
